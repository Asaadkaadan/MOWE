...
\t'rate'\t'uploaddelay'\t'downloaddelay'\r\n\r\n",
...
static portBASE_TYPE setCommand( int8_t *pcWriteBuffer, size_t xWriteBufferLen, const int8_t *pcCommandString )
{
	...
	static const int8_t *pcMode0 = ( int8_t * ) "Indicator LED is used to measure streaming rate\n\r";
	static const int8_t *pcMode1 = ( int8_t * ) "Indicator LED is used to measure upload delay\n\r";
	static const int8_t *pcMode2 = ( int8_t * ) "Indicator LED is used to measure download delay\n\r";
	...
	{
			/* LED status mode 0 */
		if (!strcmp(( char * ) pcParameterString2, "rate") ) {
			ledStatus = 0;
